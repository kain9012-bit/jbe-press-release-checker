...
- 작은따옴표나 「 」 안의 표어·행사명·제목의 **뜻이 달라진 것.** 이름은 이름대로 두어야 한다.
- 사실관계(수치, 날짜, 기관명, 사람 이름)가 달라진 것.

무엇을 잘못이라고 하지 않는가
- 취향 차이. 원래도 되고 고친 것도 되면 그냥 둔다.
- 더 나은 표현이 따로 있다는 것. 여기서는 옳고 그름만 본다.
- **표어·행사명 안이라는 이유 하나.** 표어 안이라도 로마자는 규범에 어긋난다. 이름의 뜻과
  가락은 지키면서 표기만 바로잡으면 된다. 예: 표어 속 ‘UP’ → ‘업(UP)’.

**옳은 것은 내지 마라. 잘못된 것만 낸다.** 잘못이 없으면 빈 목록을 낸다.

잘못된 자리마다 fix 에 **그 자리에 실제로 들어갈 말**을 적는다. 지시문이나 설명이 아니라
갈아 끼울 말 그대로다. 고친 것이 틀렸으면 **네가 옳게 고쳐서** 적는다.

**‘고치기 전’ 말을 그대로 적지 마라.** 되돌리는 것은 네 일이 아니다. 그 자리는 어차피
규범에 걸린 자리라 그대로 둘 수 없다. 지금 고침이 마음에 안 들면 **더 나은 말을 내라.**
정 아니면 그 id 를 아예 내지 마라.
